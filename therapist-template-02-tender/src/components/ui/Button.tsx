...
const variants: Record<Variant, string> = {
  // Deep blush background, cream text — the CTA. Uses the AA-safe deep tone.
  primary:
    "px-7 py-3.5 bg-[var(--color-blush-deep)] text-[var(--color-bg)] transition-[filter] hover:brightness-95",
  ...
  ghost:
    "text-[var(--color-ink)] underline decoration-[var(--color-blush)] decoration-1 underline-offset-4 hover:decoration-2",
};
